        ...
        <div className="rounded-[2rem] border border-white/10 bg-slate-950/80 p-6 shadow-glow">
          ...
          <div className="mt-6 space-y-4">
            {budgets.length ? budgets.map((budget) => {
              ...
              return (
                <div key={budget.id} className="rounded-3xl border border-white/10 bg-slate-900/80 p-5">
                  ...
                  {percent >= 100 ? (
                    <p className="mt-3 text-sm text-rose-300">Budget exceeded. Time to review your spending.</p>
                  ) : percent >= 80 ? (
                    <p className="mt-3 text-sm text-amber-300">You have reached 80% of your budget.</p>
                  ) : null}
                </div>
              );
            }) : (
