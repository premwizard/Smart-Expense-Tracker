...
const LoginPage = () => {
  const { register, handleSubmit, formState } = useForm<LoginPayload>({ mode: 'onTouched' });
  ...
  return (
    <AuthLayout title="Welcome back" subtitle="Sign in to manage your income, expenses, and AI-powered financial insights.">
