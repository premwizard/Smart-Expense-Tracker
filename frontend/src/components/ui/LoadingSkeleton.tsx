...
const LoadingSkeleton = () => (
  <div className="flex min-h-screen items-center justify-center px-6 py-12">
    <motion.div
      ...
      transition={{ duration: 0.45, ease: 'easeOut', repeat: Infinity, repeatType: 'mirror' }}
      className="w-full max-w-3xl rounded-3xl border border-white/10 bg-slate-900/70 p-10 shadow-glow"
    >
